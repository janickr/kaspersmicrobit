...
class TestEvent:
    def test_to_bytes(self):
        ...
        assert event.to_bytes() == bytearray.fromhex("1b 00 08 00")

    def test_from_bytes(self):
        event = Event(v1_events.DEVICE_ID_GESTURE, v1_events.EVENT_GESTURE_3G)
        assert Event.from_bytes(bytearray.fromhex("1b 00 08 00")) == event
    ...
    def test_list_to_bytes(self):
        ...
        assert Event.list_to_bytes(events) == bytearray.fromhex("1b 00 08 00 06 00 01 00")
    ...
    def test_list_from_bytes(self):
        ...
        assert Event.list_from_bytes(bytearray.fromhex("1b 00 08 00 06 00 01 00")) == events
